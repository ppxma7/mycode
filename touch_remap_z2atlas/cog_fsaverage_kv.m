...
for thisSub = 1:length(subjects)
    ...
    elseif contains(subjects{thisSub},'sub016')
        mypath = ['/Volumes/r15/DRS-TOUCHMAP/ma_ares_backup/TOUCH_REMAP/exp016/231108_share/' subjects{thisSub} '/masked_zstats/'];
    end
    %mypath = ['/Volumes/DRS-Touchmap/ma_ares_backup/prf_fsaverage/' subjects{thisSub} '/'];
    ...
    elseif contains(subjects{thisSub},'sub016')
        threshold_files = {
            [mypath 'zstat_masked_1_fsaverage.mgh'],...
            [mypath 'zstat_masked_2_fsaverage.mgh'],...
            [mypath 'zstat_masked_3_fsaverage.mgh'],...
            [mypath 'zstat_masked_4_fsaverage.mgh'],...
            [mypath 'zstat_masked_5_fsaverage.mgh'],...
            };
    end
