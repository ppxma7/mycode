...
thispath = '/Users/spmic/data/fmrs_080125_AB/fmri_data/';
...
savedir = ['/Users/' userName '/Library/CloudStorage/OneDrive-SharedLibraries-TheUniversityofNottingham/Michael_Sue - General/Claire_fmrs/090125_fmrs_AB/'];
...
myFiles = {'rp_fmrs_080125_AB_3DEPI_localiser_TE20ms_20250108085355_7.txt',...
    'rp_fmrs_080125_AB_3DEPI_localiser_TE20ms_20250108085355_8.txt'};

% nameFiles = {'1bar run 1','30 % run 1','50 % run 1',...
%     '1 bar run 2','30 % run 2','50 % run 2'};
nameFiles = {'scan7','scan8'};
