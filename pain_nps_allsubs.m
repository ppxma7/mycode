...
sub01_7T={'swrparrec_thermode_block1_20221117112738_9_nordic_clv_toppedupabs.nii',...
    ...
    'swrparrec_thermode_armblock1_20221117112738_24_nordic_clv_toppedupabs.nii',...
    'swrparrec_thermode_armblock2_20221117112738_25_nordic_clv_toppedupabs.nii'};
...
sub02_7T={'swrparrec_thermode_block1_20221117143136_9_nordic_clv_toppedupabs.nii',...
    ...
    'swrpostcap_thermode_armblock1_20221129112341_8_nordic_clv_toppedupabs.nii',...
    'swrpostcap_thermode_armblock2_20221129112341_9_nordic_clv_toppedupabs.nii'};
...
sub03_7T={'swrparrec_thermode_block1_20221129091505_11_nordic_clv_toppedupabs.nii',...
    ...
    'swrparrec_thermode_armblock1_20221129122548_8_nordic_clv_toppedupabs.nii',...
    'swrparrec_thermode_armblock2_20221129122548_9_nordic_clv_toppedupabs.nii'};
...
sub04_7T={'swrparrec_thermode_block1_20230110092418_10_nordic_clv_toppedupabs.nii',...
    ...
    'swrparrec_thermode_armblock1_20230110092418_24_nordic_clv_toppedupabs.nii',...
    'swrparrec_thermode_armblock2_20230110092418_25_nordic_clv_toppedupabs.nii'};
...
sub05_7T={'swrpain_05_11766_230123_thermode_block1_20230123094829_10_nordic_clv_toppedupabs.nii',...
    ...
    'swrpain_05_11766_230123_thermode_armblock1_20230123094829_25_nordic_clv_toppedupabs.nii',...
    'swrpain_05_11766_230123_thermode_armblock2_20230123094829_26_nordic_clv_toppedupabs.nii'};
...
sub06_7T={'swrparrec_thermode_block1_20230126092204_10_nordic_clv_toppedupabs.nii',...
    ...
    'swrparrec_thermode_armblock1_20230126092204_24_nordic_clv_toppedupabs.nii',...
    'swrparrec_thermode_armblock2_20230126092204_25_nordic_clv_toppedupabs.nii'};
...
sub07_7T={'swrparrec_thermode_block1_20230213101502_10_nordic_clv_toppedupabs.nii',...
    ...
    'swrleftover_thermode_armblock1_20230213101502_25_nordic_clv_toppedupabs.nii',...
    'swrparrec_thermode_armblock2_20230213101502_26_nordic_clv_toppedupabs.nii'};
...
%% 7T
clear data
details = {'thermode_hand_pre','thermode_arm_pre','thermode_arm_post',...
    'thermode_hand_pre','thermode_arm_pre','thermode_arm_post'}';
...
writetable(tbldom,[savedir 'mult_anova_7T'],'FileType','spreadsheet')
% 
...
%% 3T
theOrder_3T = {'Hand run1','Hand run2','Arm run1','Arm run2','TGI run1','TGI run2'};
...
sub0X_3T={'swrtgi_sub_01_13676_221124_WIPThermode-fMRI1_20221124113203_3_nordic_clv_toppedupabs.nii',...
    ...
    'swrtgi_sub_01_13676_221124_WIPTGI1_20221124113203_11_nordic_clv_toppedupabs.nii',...
    'swrtgi_sub_01_13676_221124_WIPTGI2_20221124113203_12_nordic_clv_toppedupabs.nii'};
...
sub02_3T={'swrtgi_sub_02_15435_221124_WIPThermode-fMRI1_20221124124607_2_nordic_clv_toppedupabs.nii',...
    ...
    'swrtgi_sub_02_15435_221124_WIPTGI1_20221124124607_7_nordic_clv_toppedupabs.nii',...
    'swrtgi_sub_02_15435_221124_WIPTGI2_20221124124607_8_nordic_clv_toppedupabs.nii'};
...
sub04_3T={'swrtgi_sub_03_14359_221124_WIPThermode-fMRI1_20221124135439_2_nordic_clv_toppedupabs.nii',...
    ...
    'swrtgi_sub_03_14359_221124_WIPTGI1_20221124135439_7_nordic_clv_toppedupabs.nii',...
    'swrtgi_sub_03_14359_221124_WIPTGI2_20221124135439_8_nordic_clv_toppedupabs.nii'};
...
sub01_3T={'swrtgi_sub_04_12778_221124_WIPThermode-fMRI1_20221124145248_8_nordic_clv_toppedupabs.nii',...
    ...
    'swrtgi_sub_04_12778_221124_WIPTGI1_20221124145248_4_nordic_clv_toppedupabs.nii',...
    'swrtgi_sub_04_12778_221124_WIPTGI2_20221124145248_5_nordic_clv_toppedupabs.nii'};
...
sub07_3T={'swrtherm1_nordic_clv_toppedupabs.nii',...
    ...
    'swrtgi1_nordic_clv_toppedupabs.nii',...
    'swrtgi2_nordic_clv_toppedupabs.nii'};
...
% 3T
clear data
details = {'thermode_hand','thermode_arm','tgi_hand','tgi_arm',...
    'thermode_hand','thermode_arm','tgi_hand','tgi_arm',...
    'tgi_hand','tgi_arm'}';
details_stack = repmat(details,1,length(dataList));
details_stack = details_stack(:);
...
for ii = 1:length(dataList)
    ...
    data(:,ii) = [thisSub{1,1} thisSub{3,1} thisSub{5,1} thisSub{6,1},...
        thisSub{1,2} thisSub{3,2} thisSub{5,2} thisSub{6,2},...
        thisSub{5,3} thisSub{6,3}];
...
% %add this fudgey bit to include values from Jo PFP
g.update('x',{'heat'; 'tgi';'warm';'tgi_warm';'tgi_cold'},'y',[46.29; 500; 500; 500; 500])
g.geom_jitter('edgewidth',2)
g.set_point_options('base_size',12)
g.set_color_options('map',[1 1 0])
g.draw
% 
g.update('x',{'heat'; 'tgi';'warm';'tgi_warm';'tgi_cold'},'y',[500; 500; 14.07; 500; 500])
g.geom_jitter('edgewidth',2)
g.set_point_options('base_size',12)
g.set_color_options('map',[1 1 0])
g.draw
...
tbldom.("Group A")=GNAMES(tbldom.("Group A"));
tbldom.("Group B")=GNAMES(tbldom.("Group B"));
writetable(tbldom,[savedir 'mult_anova_3T'],'FileType','spreadsheet')
