...
filename=("topup_command_subject_$subj.txt")
...
do
	...
	thisCommand="sh /Users/ppzma/Documents/MATLAB/nottingham/bin/applytoppedup.sh $bigmount${mypath[$index]}$endmount ${fMRI_Data_var}_clv ${SE_P_var}_merged"
