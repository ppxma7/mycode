...
root_folder_path = '/Users/spmic/Library/CloudStorage/OneDrive-SharedLibraries-TheUniversityofNottingham/Zespri- fMRI - General/analysis/brand/brandstats/'
#subfolders_to_search = ['scan1_vs_scan2', 'kiwi_vs_mtx','red_vs_green','red_vs_mtx']  # List the specific subfolders you want to search
subfolders_to_search = ['red', 'gold','green','brandvsnobrand']  # List the specific subfolders you want to search
    ...
    for dirpath, _, filenames in os.walk(full_subfolder_path):
        for filename in filenames:
            ...
            if filename.endswith('.csv'):
                ...
                data['Visit'] = subfolder

                # Add a new column for the text file name
                data['Contrast'] = filename.split('.')[0]
...
output_file = '/Users/spmic/Library/CloudStorage/OneDrive-SharedLibraries-TheUniversityofNottingham/Zespri- fMRI - General/analysis/brand/brandstats/combined_data_brand.xlsx'
