...
axes[0].plot(motion_params[:, 0], label='X Translation')
axes[0].plot(motion_params[:, 1], label='Y Translation')
axes[0].plot(motion_params[:, 2], label='Z Translation')
axes[0].set_title('Translations')
axes[0].set_ylabel('Translation (mm)')
axes[0].legend()

# Plot rotations (columns 3-5)
axes[1].plot(motion_params[:, 3], label='X Rotation')
axes[1].plot(motion_params[:, 4], label='Y Rotation')
axes[1].plot(motion_params[:, 5], label='Z Rotation')
