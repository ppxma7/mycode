...
rootFold = "/Volumes/kratos/CANAPI/canapi_sub14/spm_analysis/"
...
input_files = [
    "rwrcanapi_sub14_WIP1bar_TAP_R_20260226121206_3_nordic_clv.nii",
    "rwrcanapi_sub14_WIPlow_TAP_R_20260226121206_4_nordic_clv.nii",
    "rwrcanapi_sub14_WIP1bar_TAP_L_20260226121206_5_nordic_clv.nii",
    "rwrcanapi_sub14_WIPlow_TAP_L_20260226121206_6_nordic_clv.nii"
]
...
motion_files = [
    f.replace("rwr", "rp_").replace(".nii", ".txt")
    for f in input_files
]
