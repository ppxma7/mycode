...
g.geom_bar('width', 0.4, 'stacked',false,'dodge',0.5,'LineWidth',0.2) 

g.geom_interval('geom','errorbar');   % <- uses ymin/ymax that you defined

% Optional styling
g.set_names('x',[],'y','Mean T','color','Condition');
%g.set_title('Positive T-values');
g.axe_property('FontSize',12,'ylim',[0 20],'XGrid','on','YGrid','on');
