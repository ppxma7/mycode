...
for subj in subject_folders:
    ...
    qa_dir = os.path.join(root_path, subj, 'qa_outputs')
    ...
    for scan in scan_folders:
        ...
        try:
            ...
            roi_vis_path = roi_vis_path = os.path.join(savedir, f"slice_with_tsnr_{scan}.png")
...
# === Save ===
output_path = os.path.join(savedir, "tSNR_grouped_bar_chart.png")
plt.tight_layout()
...
# Save ANOVA table
anova_csv_path = os.path.join(savedir, "anova_tsnr_by_subject.csv")
...
tukey_csv_path = os.path.join(savedir, "tukey_tsnr_by_subject.csv")
