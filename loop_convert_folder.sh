...
INPUT_DIR="/Users/spmic/data/SASHB"  # Change to actual path
OUTPUT_DIR="/Users/spmic/data/SASHB/outputs"  # Change as needed
...
for folder in "$INPUT_DIR"/*/; do
    ...
    mkdir -p "$TEMP_DIR"
    dcm2niix -o "$TEMP_DIR" -f "%p_%s" "$folder"
