...
g.axe_property('XGrid','on','YGrid','on','YLim',myylim)
g.set_title('nordic')
g.draw
...
nord = {'orig','orig','orig','orig','orig','orig','orig',...
    'nord','nord','nord','nord','nord','nord','nord'};

whichScan = {'A','B','C','D','E','F','G',...
    'A','B','C','D','E','F','G'};


meantSNR = [89 183 109 178 65 111 74,...
    118 184 162 179 111 134 129];
...
g.draw
savedir='/Users/ppzma/The University of Nottingham/SPMIC User Groups - Imaging for Neuroscience/fMRI_benchmark_phantom_oct27/';
filename = 'fMRI_benchmark_tSNR_oct_27_mtx';
g.export('file_name',filename, ...
    'export_path',...
    savedir,...
    'file_type','pdf')
...
g.draw
savedir='/Users/ppzma/The University of Nottingham/SPMIC User Groups - Imaging for Neuroscience/fMRI_benchmark_phantom_oct27/';
filename = 'fMRI_benchmark_tSNR_oct_27_2_mtx';
g.export('file_name',filename, ...
    'export_path',...
    savedir,...
    'file_type','pdf')
...
clear g
figure
g = gramm('x',slice,'y',meantSNR,'color',whichScan,'marker',stack);
g.geom_jitter()
g.set_names('x','dataset','y', 'mean tSNR')
g.set_text_options('Font','Helvetica', 'base_size', 16)
g.set_point_options('base_size',basesize,'markers',{'o','h'})
g.axe_property('XGrid','on','YGrid','on','YLim',myylim)
g.set_title('multiband')
g.draw
savedir='/Users/ppzma/The University of Nottingham/SPMIC User Groups - Imaging for Neuroscience/fMRI_benchmark_phantom_oct27/';
filename = 'fMRI_benchmark_tSNR_oct_27_3_mtxrr';
g.export('file_name',filename, ...
    'export_path',...
    savedir,...
    'file_type','png')
